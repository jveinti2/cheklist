...
<div class='wrapper'>
  <div class='collapsible'>
    ...
    <div class='collapsible-text'>
      ...
      <!-- contenido del paso -->
      <!-- si -->
      <div id='DivRetencion1Si' style='display: none; padding: 20px;'>
        <h5>Accion SI</h5>
        <p>Se realiza la <b>explicación correspondiente de los valores facturados</b> y el
          valor pendiente de pago.</p>
      </div>
      <!-- no -->
      <div id='DivRetencion1No' style='display: none; padding: 20px;'>
        <h5>Accion NO</h5>
...
<div class='wrapper'>
  <div class='collapsible'>
    ...
    <div class='collapsible-text'>
      ...
      <!-- contenido del paso -->
      <!-- si -->
      <div id='DivRetencion2Si' style='display: none; padding: 20px;'>
        <h5>Accion SI</h5>
      ...
      <!-- no -->
      <div id='DivRetencion2No' style='display: none; padding: 20px;'>
        <h5>Accion NO</h5>
